...
この wiki の content-oriented catalog。  
新しい page を作ったらここを更新する。

## overview

- [[LLM Wiki/wiki/overview]] - この wiki の現時点の全体像、仮説、優先テーマ。
- [[LLM Wiki/wiki/log]] - 何をいつ ingest / query / lint したかの時系列記録。
...
- [[LLM Wiki/wiki/entities/CoDesignAI]] - 協働の場を AI がどう構造化するかを示す prototype platform。
- [[LLM Wiki/wiki/entities/菅原道真]] - 怨霊から天神へ転化した代表例として読むべき人物。

## concepts

- [[LLM Wiki/wiki/concepts/AIファシリテーター]] - AI を答える存在ではなく、協働を進行・要約・調停する役割として捉える概念。
- [[LLM Wiki/wiki/concepts/ラウンド型協働]] - 全員の入力が揃ってから synthesis を走らせる協働プロトコル。
